 ...
 */
@property (readonly) GBErrorCategory GBerrorCategory;
...
/*!
 ...
 @discussion
 In general if gberrorShouldNotifyUser is NO, then the application has a straightforward mitigation, such as
 ...
 see https://developers.facebook.com/docs/reference/api/errors/
 */
@property (readonly) BOOL gberrorShouldNotifyUser;
 ...
 */
@property (readonly, copy) NSString *gberrorUserMessage;
